  ...
  return (
    <div className="min-h-screen flex bg-furia-black overflow-hidden">
      ...
      <main className="flex-1 flex flex-col animate-fade-in relative">
        ...
        {/* Header for mobile */}
        <header className="md:hidden flex items-center justify-between px-4 py-3 border-b border-furia-gray/30 bg-furia-black/90 backdrop-blur-sm sticky top-0 z-10">
        ...
        {/* Header for desktop */}
        <header className="hidden md:flex items-center justify-end px-6 py-3 border-b border-furia-gray/30 bg-furia-black/90 backdrop-blur-sm sticky top-0 z-10">
          {isAuthenticated && <NotificationCenter />}
        </header>
